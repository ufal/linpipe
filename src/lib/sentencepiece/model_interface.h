...
std::vector<absl::string_view> SplitIntoWords(
    linpipe::sentencepiece::absl::string_view text, bool treat_ws_as_suffix = false,
...
class ModelInterface {
 public:
  using PieceToIdMap = linpipe::sentencepiece::absl::flat_hash_map<absl::string_view, int>;
  //                                           string_util::string_view_hash>;

  linpipe::sentencepiece::absl::string_view unk_piece() const;
  linpipe::sentencepiece::absl::string_view bos_piece() const;
  linpipe::sentencepiece::absl::string_view eos_piece() const;
  linpipe::sentencepiece::absl::string_view pad_piece() const;
