...
class Lattice {
 public:
  ...
  struct Node {
    linpipe::sentencepiece::absl::string_view piece;  // Sentence piece representation.
 ...
 private:
  ...
  linpipe::sentencepiece::absl::string_view sentence_;
...
class Model : public ModelInterface {
 public:
  ...
  bool VerifyOutputsEquivalent(absl::string_view expected,
                               linpipe::sentencepiece::absl::string_view actual) const override;
