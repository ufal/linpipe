...
class Splitter {
 public:
  Splitter(absl::string_view str, linpipe::sentencepiece::absl::string_view delim, bool allow_empty) {
    size_t current_pos = 0;
    size_t found_pos = 0;
    while ((found_pos = str.find_first_of(delim, current_pos)) !=
           linpipe::sentencepiece::absl::string_view::npos) {
...
inline internal::Splitter StrSplit(absl::string_view str,
                                   linpipe::sentencepiece::absl::string_view delim,
