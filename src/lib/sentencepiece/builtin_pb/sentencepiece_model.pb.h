...
#include "lib/sentencepiece/third_party/protobuf-lite/google/protobuf/repeated_field.h"  // IWYU pragma: export
#include "lib/sentencepiece/third_party/protobuf-lite/google/protobuf/extension_set.h"  // IWYU pragma: export
...
PROTOBUF_NAMESPACE_OPEN
template<> ::linpipe::sentencepiece::ModelProto* Arena::CreateMaybeMessage<::linpipe::sentencepiece::ModelProto>(Arena*);
template<> ::linpipe::sentencepiece::ModelProto_SentencePiece* Arena::CreateMaybeMessage<::linpipe::sentencepiece::ModelProto_SentencePiece>(Arena*);
template<> ::linpipe::sentencepiece::NormalizerSpec* Arena::CreateMaybeMessage<::linpipe::sentencepiece::NormalizerSpec>(Arena*);
template<> ::linpipe::sentencepiece::SelfTestData* Arena::CreateMaybeMessage<::linpipe::sentencepiece::SelfTestData>(Arena*);
template<> ::linpipe::sentencepiece::SelfTestData_Sample* Arena::CreateMaybeMessage<::linpipe::sentencepiece::SelfTestData_Sample>(Arena*);
template<> ::linpipe::sentencepiece::TrainerSpec* Arena::CreateMaybeMessage<::linpipe::sentencepiece::TrainerSpec>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace linpipe::sentencepiece {
...
class TrainerSpec PROTOBUF_FINAL :
 ...
 public:
  ...
  ::linpipe::sentencepiece::TrainerSpec_ModelType model_type() const;
  void set_model_type(::linpipe::sentencepiece::TrainerSpec_ModelType value);
  private:
  ::linpipe::sentencepiece::TrainerSpec_ModelType _internal_model_type() const;
  void _internal_set_model_type(::linpipe::sentencepiece::TrainerSpec_ModelType value);
  public:
...
class SelfTestData PROTOBUF_FINAL :
 ...
 public:
  ...
  public:
  void clear_samples();
  ::linpipe::sentencepiece::SelfTestData_Sample* mutable_samples(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::linpipe::sentencepiece::SelfTestData_Sample >*
      mutable_samples();
  private:
  const ::linpipe::sentencepiece::SelfTestData_Sample& _internal_samples(int index) const;
  ::linpipe::sentencepiece::SelfTestData_Sample* _internal_add_samples();
  public:
  const ::linpipe::sentencepiece::SelfTestData_Sample& samples(int index) const;
  ::linpipe::sentencepiece::SelfTestData_Sample* add_samples();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::linpipe::sentencepiece::SelfTestData_Sample >&
      samples() const;
 ...
 private:
  ...
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::linpipe::sentencepiece::SelfTestData_Sample > samples_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_sentencepiece_5fmodel_2eproto;
};
// -------------------------------------------------------------------
...
class ModelProto_SentencePiece PROTOBUF_FINAL :
 ...
 public:
  ...
  public:
  void clear_type();
  ::linpipe::sentencepiece::ModelProto_SentencePiece_Type type() const;
  void set_type(::linpipe::sentencepiece::ModelProto_SentencePiece_Type value);
  private:
  ::linpipe::sentencepiece::ModelProto_SentencePiece_Type _internal_type() const;
  void _internal_set_type(::linpipe::sentencepiece::ModelProto_SentencePiece_Type value);
  public:
...
class ModelProto PROTOBUF_FINAL :
 ...
 public:
  ...
  public:
  void clear_pieces();
  ::linpipe::sentencepiece::ModelProto_SentencePiece* mutable_pieces(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::linpipe::sentencepiece::ModelProto_SentencePiece >*
      mutable_pieces();
  private:
  const ::linpipe::sentencepiece::ModelProto_SentencePiece& _internal_pieces(int index) const;
  ::linpipe::sentencepiece::ModelProto_SentencePiece* _internal_add_pieces();
  public:
  const ::linpipe::sentencepiece::ModelProto_SentencePiece& pieces(int index) const;
  ::linpipe::sentencepiece::ModelProto_SentencePiece* add_pieces();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::linpipe::sentencepiece::ModelProto_SentencePiece >&
      pieces() const;
  ...
  const ::linpipe::sentencepiece::TrainerSpec& trainer_spec() const;
  ::linpipe::sentencepiece::TrainerSpec* release_trainer_spec();
  ::linpipe::sentencepiece::TrainerSpec* mutable_trainer_spec();
  void set_allocated_trainer_spec(::linpipe::sentencepiece::TrainerSpec* trainer_spec);
  private:
  const ::linpipe::sentencepiece::TrainerSpec& _internal_trainer_spec() const;
  ::linpipe::sentencepiece::TrainerSpec* _internal_mutable_trainer_spec();
  public:
  void unsafe_arena_set_allocated_trainer_spec(
      ::linpipe::sentencepiece::TrainerSpec* trainer_spec);
  ::linpipe::sentencepiece::TrainerSpec* unsafe_arena_release_trainer_spec();
  ...
  const ::linpipe::sentencepiece::NormalizerSpec& normalizer_spec() const;
  ::linpipe::sentencepiece::NormalizerSpec* release_normalizer_spec();
  ::linpipe::sentencepiece::NormalizerSpec* mutable_normalizer_spec();
  void set_allocated_normalizer_spec(::linpipe::sentencepiece::NormalizerSpec* normalizer_spec);
  private:
  const ::linpipe::sentencepiece::NormalizerSpec& _internal_normalizer_spec() const;
  ::linpipe::sentencepiece::NormalizerSpec* _internal_mutable_normalizer_spec();
  public:
  void unsafe_arena_set_allocated_normalizer_spec(
      ::linpipe::sentencepiece::NormalizerSpec* normalizer_spec);
  ::linpipe::sentencepiece::NormalizerSpec* unsafe_arena_release_normalizer_spec();
  ...
  const ::linpipe::sentencepiece::SelfTestData& self_test_data() const;
  ::linpipe::sentencepiece::SelfTestData* release_self_test_data();
  ::linpipe::sentencepiece::SelfTestData* mutable_self_test_data();
  void set_allocated_self_test_data(::linpipe::sentencepiece::SelfTestData* self_test_data);
  private:
  const ::linpipe::sentencepiece::SelfTestData& _internal_self_test_data() const;
  ::linpipe::sentencepiece::SelfTestData* _internal_mutable_self_test_data();
  public:
  void unsafe_arena_set_allocated_self_test_data(
      ::linpipe::sentencepiece::SelfTestData* self_test_data);
  ::linpipe::sentencepiece::SelfTestData* unsafe_arena_release_self_test_data();
  ...
  const ::linpipe::sentencepiece::NormalizerSpec& denormalizer_spec() const;
  ::linpipe::sentencepiece::NormalizerSpec* release_denormalizer_spec();
  ::linpipe::sentencepiece::NormalizerSpec* mutable_denormalizer_spec();
  void set_allocated_denormalizer_spec(::linpipe::sentencepiece::NormalizerSpec* denormalizer_spec);
  private:
  const ::linpipe::sentencepiece::NormalizerSpec& _internal_denormalizer_spec() const;
  ::linpipe::sentencepiece::NormalizerSpec* _internal_mutable_denormalizer_spec();
  public:
  void unsafe_arena_set_allocated_denormalizer_spec(
      ::linpipe::sentencepiece::NormalizerSpec* denormalizer_spec);
  ::linpipe::sentencepiece::NormalizerSpec* unsafe_arena_release_denormalizer_spec();
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::HasBits<1> _has_bits_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::linpipe::sentencepiece::ModelProto_SentencePiece > pieces_;
  ::linpipe::sentencepiece::TrainerSpec* trainer_spec_;
  ::linpipe::sentencepiece::NormalizerSpec* normalizer_spec_;
  ::linpipe::sentencepiece::SelfTestData* self_test_data_;
  ::linpipe::sentencepiece::NormalizerSpec* denormalizer_spec_;
  friend struct ::TableStruct_sentencepiece_5fmodel_2eproto;
};
// ===================================================================
...
inline ::linpipe::sentencepiece::TrainerSpec_ModelType TrainerSpec::_internal_model_type() const {
  return static_cast< ::linpipe::sentencepiece::TrainerSpec_ModelType >(model_type_);
}
inline ::linpipe::sentencepiece::TrainerSpec_ModelType TrainerSpec::model_type() const {
  // @@protoc_insertion_point(field_get:sentencepiece.TrainerSpec.model_type)
  return _internal_model_type();
}
inline void TrainerSpec::_internal_set_model_type(::linpipe::sentencepiece::TrainerSpec_ModelType value) {
  assert(::linpipe::sentencepiece::TrainerSpec_ModelType_IsValid(value));
  _has_bits_[0] |= 0x00800000u;
  model_type_ = value;
}
inline void TrainerSpec::set_model_type(::linpipe::sentencepiece::TrainerSpec_ModelType value) {
...
inline void TrainerSpec::clear_unk_piece() {
  unk_piece_.ClearToDefault(::linpipe::sentencepiece::TrainerSpec::_i_give_permission_to_break_this_code_default_unk_piece_, GetArena());
...
inline std::string* TrainerSpec::_internal_mutable_unk_piece() {
  _has_bits_[0] |= 0x00000010u;
  return unk_piece_.Mutable(::linpipe::sentencepiece::TrainerSpec::_i_give_permission_to_break_this_code_default_unk_piece_, GetArena());
}
...
inline void TrainerSpec::clear_bos_piece() {
  bos_piece_.ClearToDefault(::linpipe::sentencepiece::TrainerSpec::_i_give_permission_to_break_this_code_default_bos_piece_, GetArena());
...
inline std::string* TrainerSpec::_internal_mutable_bos_piece() {
  _has_bits_[0] |= 0x00000020u;
  return bos_piece_.Mutable(::linpipe::sentencepiece::TrainerSpec::_i_give_permission_to_break_this_code_default_bos_piece_, GetArena());
}
...
inline void TrainerSpec::clear_eos_piece() {
  eos_piece_.ClearToDefault(::linpipe::sentencepiece::TrainerSpec::_i_give_permission_to_break_this_code_default_eos_piece_, GetArena());
...
inline std::string* TrainerSpec::_internal_mutable_eos_piece() {
  _has_bits_[0] |= 0x00000040u;
  return eos_piece_.Mutable(::linpipe::sentencepiece::TrainerSpec::_i_give_permission_to_break_this_code_default_eos_piece_, GetArena());
}
...
inline void TrainerSpec::clear_pad_piece() {
  pad_piece_.ClearToDefault(::linpipe::sentencepiece::TrainerSpec::_i_give_permission_to_break_this_code_default_pad_piece_, GetArena());
...
inline std::string* TrainerSpec::_internal_mutable_pad_piece() {
  _has_bits_[0] |= 0x00000080u;
  return pad_piece_.Mutable(::linpipe::sentencepiece::TrainerSpec::_i_give_permission_to_break_this_code_default_pad_piece_, GetArena());
}
...
inline void TrainerSpec::clear_unk_surface() {
  unk_surface_.ClearToDefault(::linpipe::sentencepiece::TrainerSpec::_i_give_permission_to_break_this_code_default_unk_surface_, GetArena());
...
inline std::string* TrainerSpec::_internal_mutable_unk_surface() {
  _has_bits_[0] |= 0x00000008u;
  return unk_surface_.Mutable(::linpipe::sentencepiece::TrainerSpec::_i_give_permission_to_break_this_code_default_unk_surface_, GetArena());
}
...
inline ::linpipe::sentencepiece::SelfTestData_Sample* SelfTestData::mutable_samples(int index) {
  // @@protoc_insertion_point(field_mutable:sentencepiece.SelfTestData.samples)
  return samples_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::linpipe::sentencepiece::SelfTestData_Sample >*
SelfTestData::mutable_samples() {
  // @@protoc_insertion_point(field_mutable_list:sentencepiece.SelfTestData.samples)
  return &samples_;
}
inline const ::linpipe::sentencepiece::SelfTestData_Sample& SelfTestData::_internal_samples(int index) const {
  return samples_.Get(index);
}
inline const ::linpipe::sentencepiece::SelfTestData_Sample& SelfTestData::samples(int index) const {
  // @@protoc_insertion_point(field_get:sentencepiece.SelfTestData.samples)
  return _internal_samples(index);
}
inline ::linpipe::sentencepiece::SelfTestData_Sample* SelfTestData::_internal_add_samples() {
  return samples_.Add();
}
inline ::linpipe::sentencepiece::SelfTestData_Sample* SelfTestData::add_samples() {
  // @@protoc_insertion_point(field_add:sentencepiece.SelfTestData.samples)
  return _internal_add_samples();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::linpipe::sentencepiece::SelfTestData_Sample >&
...
inline ::linpipe::sentencepiece::ModelProto_SentencePiece_Type ModelProto_SentencePiece::_internal_type() const {
  return static_cast< ::linpipe::sentencepiece::ModelProto_SentencePiece_Type >(type_);
}
inline ::linpipe::sentencepiece::ModelProto_SentencePiece_Type ModelProto_SentencePiece::type() const {
  // @@protoc_insertion_point(field_get:sentencepiece.ModelProto.SentencePiece.type)
  return _internal_type();
}
inline void ModelProto_SentencePiece::_internal_set_type(::linpipe::sentencepiece::ModelProto_SentencePiece_Type value) {
  assert(::linpipe::sentencepiece::ModelProto_SentencePiece_Type_IsValid(value));
  _has_bits_[0] |= 0x00000004u;
  type_ = value;
}
inline void ModelProto_SentencePiece::set_type(::linpipe::sentencepiece::ModelProto_SentencePiece_Type value) {
...
inline ::linpipe::sentencepiece::ModelProto_SentencePiece* ModelProto::mutable_pieces(int index) {
  // @@protoc_insertion_point(field_mutable:sentencepiece.ModelProto.pieces)
  return pieces_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::linpipe::sentencepiece::ModelProto_SentencePiece >*
ModelProto::mutable_pieces() {
  // @@protoc_insertion_point(field_mutable_list:sentencepiece.ModelProto.pieces)
  return &pieces_;
}
inline const ::linpipe::sentencepiece::ModelProto_SentencePiece& ModelProto::_internal_pieces(int index) const {
  return pieces_.Get(index);
}
inline const ::linpipe::sentencepiece::ModelProto_SentencePiece& ModelProto::pieces(int index) const {
  // @@protoc_insertion_point(field_get:sentencepiece.ModelProto.pieces)
  return _internal_pieces(index);
}
inline ::linpipe::sentencepiece::ModelProto_SentencePiece* ModelProto::_internal_add_pieces() {
  return pieces_.Add();
}
inline ::linpipe::sentencepiece::ModelProto_SentencePiece* ModelProto::add_pieces() {
  // @@protoc_insertion_point(field_add:sentencepiece.ModelProto.pieces)
  return _internal_add_pieces();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::linpipe::sentencepiece::ModelProto_SentencePiece >&
...
inline const ::linpipe::sentencepiece::TrainerSpec& ModelProto::_internal_trainer_spec() const {
  const ::linpipe::sentencepiece::TrainerSpec* p = trainer_spec_;
  return p != nullptr ? *p : reinterpret_cast<const ::linpipe::sentencepiece::TrainerSpec&>(
      ::linpipe::sentencepiece::_TrainerSpec_default_instance_);
}
inline const ::linpipe::sentencepiece::TrainerSpec& ModelProto::trainer_spec() const {
...
inline ::linpipe::sentencepiece::TrainerSpec* ModelProto::release_trainer_spec() {
  _has_bits_[0] &= ~0x00000001u;
  ::linpipe::sentencepiece::TrainerSpec* temp = trainer_spec_;
...
inline ::linpipe::sentencepiece::TrainerSpec* ModelProto::unsafe_arena_release_trainer_spec() {
...
inline ::linpipe::sentencepiece::TrainerSpec* ModelProto::_internal_mutable_trainer_spec() {
  _has_bits_[0] |= 0x00000001u;
  if (trainer_spec_ == nullptr) {
    auto* p = CreateMaybeMessage<::linpipe::sentencepiece::TrainerSpec>(GetArena());
    trainer_spec_ = p;
  }
  return trainer_spec_;
}
inline ::linpipe::sentencepiece::TrainerSpec* ModelProto::mutable_trainer_spec() {
  // @@protoc_insertion_point(field_mutable:sentencepiece.ModelProto.trainer_spec)
  return _internal_mutable_trainer_spec();
}
inline void ModelProto::set_allocated_trainer_spec(::linpipe::sentencepiece::TrainerSpec* trainer_spec) {
...
inline const ::linpipe::sentencepiece::NormalizerSpec& ModelProto::_internal_normalizer_spec() const {
  const ::linpipe::sentencepiece::NormalizerSpec* p = normalizer_spec_;
  return p != nullptr ? *p : reinterpret_cast<const ::linpipe::sentencepiece::NormalizerSpec&>(
      ::linpipe::sentencepiece::_NormalizerSpec_default_instance_);
}
inline const ::linpipe::sentencepiece::NormalizerSpec& ModelProto::normalizer_spec() const {
...
inline ::linpipe::sentencepiece::NormalizerSpec* ModelProto::release_normalizer_spec() {
  _has_bits_[0] &= ~0x00000002u;
  ::linpipe::sentencepiece::NormalizerSpec* temp = normalizer_spec_;
...
inline ::linpipe::sentencepiece::NormalizerSpec* ModelProto::unsafe_arena_release_normalizer_spec() {
...
inline ::linpipe::sentencepiece::NormalizerSpec* ModelProto::_internal_mutable_normalizer_spec() {
  _has_bits_[0] |= 0x00000002u;
  if (normalizer_spec_ == nullptr) {
    auto* p = CreateMaybeMessage<::linpipe::sentencepiece::NormalizerSpec>(GetArena());
    normalizer_spec_ = p;
  }
  return normalizer_spec_;
}
inline ::linpipe::sentencepiece::NormalizerSpec* ModelProto::mutable_normalizer_spec() {
  // @@protoc_insertion_point(field_mutable:sentencepiece.ModelProto.normalizer_spec)
  return _internal_mutable_normalizer_spec();
}
inline void ModelProto::set_allocated_normalizer_spec(::linpipe::sentencepiece::NormalizerSpec* normalizer_spec) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArena();
  if (message_arena == nullptr) {
...
inline const ::linpipe::sentencepiece::SelfTestData& ModelProto::_internal_self_test_data() const {
  const ::linpipe::sentencepiece::SelfTestData* p = self_test_data_;
  return p != nullptr ? *p : reinterpret_cast<const ::linpipe::sentencepiece::SelfTestData&>(
      ::linpipe::sentencepiece::_SelfTestData_default_instance_);
}
inline const ::linpipe::sentencepiece::SelfTestData& ModelProto::self_test_data() const {
...
inline ::linpipe::sentencepiece::SelfTestData* ModelProto::release_self_test_data() {
  _has_bits_[0] &= ~0x00000004u;
  ::linpipe::sentencepiece::SelfTestData* temp = self_test_data_;
...
inline ::linpipe::sentencepiece::SelfTestData* ModelProto::unsafe_arena_release_self_test_data() {
...
inline ::linpipe::sentencepiece::SelfTestData* ModelProto::_internal_mutable_self_test_data() {
  _has_bits_[0] |= 0x00000004u;
  if (self_test_data_ == nullptr) {
    auto* p = CreateMaybeMessage<::linpipe::sentencepiece::SelfTestData>(GetArena());
    self_test_data_ = p;
  }
  return self_test_data_;
}
inline ::linpipe::sentencepiece::SelfTestData* ModelProto::mutable_self_test_data() {
  // @@protoc_insertion_point(field_mutable:sentencepiece.ModelProto.self_test_data)
  return _internal_mutable_self_test_data();
}
inline void ModelProto::set_allocated_self_test_data(::linpipe::sentencepiece::SelfTestData* self_test_data) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArena();
  if (message_arena == nullptr) {
...
inline const ::linpipe::sentencepiece::NormalizerSpec& ModelProto::_internal_denormalizer_spec() const {
  const ::linpipe::sentencepiece::NormalizerSpec* p = denormalizer_spec_;
  return p != nullptr ? *p : reinterpret_cast<const ::linpipe::sentencepiece::NormalizerSpec&>(
      ::linpipe::sentencepiece::_NormalizerSpec_default_instance_);
}
inline const ::linpipe::sentencepiece::NormalizerSpec& ModelProto::denormalizer_spec() const {
...
inline ::linpipe::sentencepiece::NormalizerSpec* ModelProto::release_denormalizer_spec() {
  _has_bits_[0] &= ~0x00000008u;
  ::linpipe::sentencepiece::NormalizerSpec* temp = denormalizer_spec_;
...
inline ::linpipe::sentencepiece::NormalizerSpec* ModelProto::unsafe_arena_release_denormalizer_spec() {
...
inline ::linpipe::sentencepiece::NormalizerSpec* ModelProto::_internal_mutable_denormalizer_spec() {
  _has_bits_[0] |= 0x00000008u;
...
inline ::linpipe::sentencepiece::NormalizerSpec* ModelProto::mutable_denormalizer_spec() {
...
inline void ModelProto::set_allocated_denormalizer_spec(::linpipe::sentencepiece::NormalizerSpec* denormalizer_spec) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArena();
  if (message_arena == nullptr) {
...
template <> struct is_proto_enum< ::linpipe::sentencepiece::TrainerSpec_ModelType> : ::std::true_type {};
template <> struct is_proto_enum< ::linpipe::sentencepiece::ModelProto_SentencePiece_Type> : ::std::true_type {};
