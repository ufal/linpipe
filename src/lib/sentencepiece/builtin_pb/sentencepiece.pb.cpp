...
static void InitDefaultsscc_info_NBestSentencePieceText_sentencepiece_2eproto() {
  ...
  {
    void* ptr = &::linpipe::sentencepiece::_NBestSentencePieceText_default_instance_;
    new (ptr) ::linpipe::sentencepiece::NBestSentencePieceText();
...
static void InitDefaultsscc_info_SentencePieceText_sentencepiece_2eproto() {
  ...
  {
    void* ptr = &::linpipe::sentencepiece::_SentencePieceText_default_instance_;
    new (ptr) ::linpipe::sentencepiece::SentencePieceText();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
}
...
static void InitDefaultsscc_info_SentencePieceText_SentencePiece_sentencepiece_2eproto() {
  ...
  {
    void* ptr = &::linpipe::sentencepiece::_SentencePieceText_SentencePiece_default_instance_;
    new (ptr) ::linpipe::sentencepiece::SentencePieceText_SentencePiece();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
}
...
template<> PROTOBUF_NOINLINE ::linpipe::sentencepiece::SentencePieceText_SentencePiece* Arena::CreateMaybeMessage< ::linpipe::sentencepiece::SentencePieceText_SentencePiece >(Arena* arena) {
  return Arena::CreateMessageInternal< ::linpipe::sentencepiece::SentencePieceText_SentencePiece >(arena);
}
template<> PROTOBUF_NOINLINE ::linpipe::sentencepiece::SentencePieceText* Arena::CreateMaybeMessage< ::linpipe::sentencepiece::SentencePieceText >(Arena* arena) {
  return Arena::CreateMessageInternal< ::linpipe::sentencepiece::SentencePieceText >(arena);
}
template<> PROTOBUF_NOINLINE ::linpipe::sentencepiece::NBestSentencePieceText* Arena::CreateMaybeMessage< ::linpipe::sentencepiece::NBestSentencePieceText >(Arena* arena) {
  return Arena::CreateMessageInternal< ::linpipe::sentencepiece::NBestSentencePieceText >(arena);
}
