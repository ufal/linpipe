...
PROTOBUF_NAMESPACE_OPEN
template<> ::linpipe::sentencepiece::NBestSentencePieceText* Arena::CreateMaybeMessage<::linpipe::sentencepiece::NBestSentencePieceText>(Arena*);
template<> ::linpipe::sentencepiece::SentencePieceText* Arena::CreateMaybeMessage<::linpipe::sentencepiece::SentencePieceText>(Arena*);
template<> ::linpipe::sentencepiece::SentencePieceText_SentencePiece* Arena::CreateMaybeMessage<::linpipe::sentencepiece::SentencePieceText_SentencePiece>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace linpipe::sentencepiece {
...
class SentencePieceText PROTOBUF_FINAL :
 ...
 public:
  ...
  public:
  void clear_pieces();
  ::linpipe::sentencepiece::SentencePieceText_SentencePiece* mutable_pieces(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::linpipe::sentencepiece::SentencePieceText_SentencePiece >*
      mutable_pieces();
  private:
  const ::linpipe::sentencepiece::SentencePieceText_SentencePiece& _internal_pieces(int index) const;
  ::linpipe::sentencepiece::SentencePieceText_SentencePiece* _internal_add_pieces();
  public:
  const ::linpipe::sentencepiece::SentencePieceText_SentencePiece& pieces(int index) const;
  ::linpipe::sentencepiece::SentencePieceText_SentencePiece* add_pieces();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::linpipe::sentencepiece::SentencePieceText_SentencePiece >&
      pieces() const;
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::HasBits<1> _has_bits_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::linpipe::sentencepiece::SentencePieceText_SentencePiece > pieces_;
...
class NBestSentencePieceText PROTOBUF_FINAL :
 ...
 public:
  ...
  public:
  void clear_nbests();
  ::linpipe::sentencepiece::SentencePieceText* mutable_nbests(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::linpipe::sentencepiece::SentencePieceText >*
      mutable_nbests();
  private:
  const ::linpipe::sentencepiece::SentencePieceText& _internal_nbests(int index) const;
  ::linpipe::sentencepiece::SentencePieceText* _internal_add_nbests();
  public:
  const ::linpipe::sentencepiece::SentencePieceText& nbests(int index) const;
  ::linpipe::sentencepiece::SentencePieceText* add_nbests();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::linpipe::sentencepiece::SentencePieceText >&
      nbests() const;
 ...
 private:
  ...
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::linpipe::sentencepiece::SentencePieceText > nbests_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_sentencepiece_2eproto;
};
// ===================================================================
...
inline ::linpipe::sentencepiece::SentencePieceText_SentencePiece* SentencePieceText::mutable_pieces(int index) {
  // @@protoc_insertion_point(field_mutable:sentencepiece.SentencePieceText.pieces)
  return pieces_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::linpipe::sentencepiece::SentencePieceText_SentencePiece >*
SentencePieceText::mutable_pieces() {
  // @@protoc_insertion_point(field_mutable_list:sentencepiece.SentencePieceText.pieces)
  return &pieces_;
}
inline const ::linpipe::sentencepiece::SentencePieceText_SentencePiece& SentencePieceText::_internal_pieces(int index) const {
  return pieces_.Get(index);
}
inline const ::linpipe::sentencepiece::SentencePieceText_SentencePiece& SentencePieceText::pieces(int index) const {
  // @@protoc_insertion_point(field_get:sentencepiece.SentencePieceText.pieces)
  return _internal_pieces(index);
}
inline ::linpipe::sentencepiece::SentencePieceText_SentencePiece* SentencePieceText::_internal_add_pieces() {
  return pieces_.Add();
}
inline ::linpipe::sentencepiece::SentencePieceText_SentencePiece* SentencePieceText::add_pieces() {
  // @@protoc_insertion_point(field_add:sentencepiece.SentencePieceText.pieces)
  return _internal_add_pieces();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::linpipe::sentencepiece::SentencePieceText_SentencePiece >&
...
inline ::linpipe::sentencepiece::SentencePieceText* NBestSentencePieceText::mutable_nbests(int index) {
  // @@protoc_insertion_point(field_mutable:sentencepiece.NBestSentencePieceText.nbests)
  return nbests_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::linpipe::sentencepiece::SentencePieceText >*
...
inline const ::linpipe::sentencepiece::SentencePieceText& NBestSentencePieceText::_internal_nbests(int index) const {
  return nbests_.Get(index);
}
inline const ::linpipe::sentencepiece::SentencePieceText& NBestSentencePieceText::nbests(int index) const {
  // @@protoc_insertion_point(field_get:sentencepiece.NBestSentencePieceText.nbests)
  return _internal_nbests(index);
}
inline ::linpipe::sentencepiece::SentencePieceText* NBestSentencePieceText::_internal_add_nbests() {
  return nbests_.Add();
}
inline ::linpipe::sentencepiece::SentencePieceText* NBestSentencePieceText::add_nbests() {
  // @@protoc_insertion_point(field_add:sentencepiece.NBestSentencePieceText.nbests)
  return _internal_add_nbests();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::linpipe::sentencepiece::SentencePieceText >&
