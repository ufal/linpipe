...
class PrefixMatcher {
 public:
  ...
  std::string GlobalReplace(absl::string_view w, linpipe::sentencepiece::absl::string_view out) const;
...
class Normalizer {
 ...
 private:
  ...
  //
  // string output;
  // linpipe::sentencepiece::absl::string_view input = "...";
  // while (!input.empty()) {
