...
#include "lib/liblzma/lz/lz_encoder.h"
#include "lib/liblzma/lz/lz_encoder_hash.h"

// See lz_encoder_hash.h. This is a bit hackish but avoids making
// endianness a conditional in makefiles.
#if defined(WORDS_BIGENDIAN) && !defined(HAVE_SMALL)
#	include "lib/liblzma/lz/lz_encoder_hash_table.h"
#endif

#include "lib/liblzma/common/memcmplen.h"
