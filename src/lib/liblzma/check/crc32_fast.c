...
#include "lib/liblzma/check/check.h"
#include "lib/liblzma/check/crc_common.h"

#if defined(CRC_X86_CLMUL)
#	define BUILDING_CRC_CLMUL 32
#	include "lib/liblzma/check/crc_x86_clmul.h"
#elif defined(CRC32_ARM64)
#	include "lib/liblzma/check/crc32_arm64.h"
#elif defined(CRC32_LOONGARCH)
#	include "lib/liblzma/check/crc32_loongarch.h"
#endif
...
#	include "lib/liblzma/check/crc32_table_be.h"
#else
#	include "lib/liblzma/check/crc32_table_le.h"
#endif
