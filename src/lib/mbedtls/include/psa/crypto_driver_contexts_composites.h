...
#include "lib/mbedtls/include/mbedtls/private/crypto_builtin_composites.h"

/* Include the context structure definitions for those drivers that were
 * declared during the autogeneration process. */
#if defined(TF_PSA_CRYPTO_PQCP_MLDSA_ENABLED)
#include "lib/mbedtls/include/tf-psa-crypto/private/crypto_struct_pqcp.h"
#endif

#if defined(MBEDTLS_TEST_LIBTESTDRIVER1)
#if defined(TF_PSA_CRYPTO_TEST_LIBTESTDRIVER1)
#include "lib/mbedtls/include/mbedtls/private/libtestdriver1-crypto_builtin_composites.h"
#else
