...
#else
#include "lib/mbedtls/include/psa/crypto_config.h"
#endif
...
#include "lib/mbedtls/include/tf-psa-crypto/private/crypto_adjust_config_synonyms.h"
#include "lib/mbedtls/include/tf-psa-crypto/private/crypto_adjust_config_auto_enabled.h"
#include "lib/mbedtls/include/tf-psa-crypto/private/crypto_adjust_config_dependencies.h"
#include "lib/mbedtls/include/tf-psa-crypto/private/crypto_adjust_config_key_pair_types.h"

/* Define additional internal symbols based on the library configuration. */
#include "lib/mbedtls/include/tf-psa-crypto/private/crypto_adjust_config_derived.h"
 ...
 * accelerated. */
#include "lib/mbedtls/include/mbedtls/private/crypto_adjust_config_enable_builtins.h"

#if defined(TF_PSA_CRYPTO_TEST_LIBTESTDRIVER1)
#include "lib/mbedtls/include/mbedtls/private/libtestdriver1-crypto_adjust_config_enable_builtins.h"
#endif
...
#include "lib/mbedtls/include/mbedtls/private/config_adjust_test_accelerators.h"
#endif
#endif /* MBEDTLS_PSA_CRYPTO_C */

/* Define additional symbols used by support modules. */
#include "lib/mbedtls/include/tf-psa-crypto/private/crypto_adjust_config_support.h"

/* Define additional symbols used by built-in crypto modules. */
#include "lib/mbedtls/include/mbedtls/private/crypto_adjust_config_tweak_builtins.h"

#if defined(TF_PSA_CRYPTO_TEST_LIBTESTDRIVER1)
#include "lib/mbedtls/include/mbedtls/private/libtestdriver1-crypto_adjust_config_tweak_builtins.h"
#endif
