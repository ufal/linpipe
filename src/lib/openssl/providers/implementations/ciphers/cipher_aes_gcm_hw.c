...
# include "lib/openssl/providers/implementations/ciphers/cipher_aes_gcm_hw_rv64i.inc"
#elif defined(OPENSSL_CPUID_OBJ) && defined(__riscv) && __riscv_xlen == 32
# include "lib/openssl/providers/implementations/ciphers/cipher_aes_gcm_hw_rv32i.inc"
#else
