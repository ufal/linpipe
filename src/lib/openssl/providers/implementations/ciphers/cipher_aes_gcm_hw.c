...
#include "lib/openssl/providers/implementations/ciphers/cipher_aes_gcm.h"
...
# include "lib/openssl/providers/implementations/ciphers/cipher_aes_gcm_hw_s390x.inc"
#elif defined(AESNI_CAPABLE)
# include "lib/openssl/providers/implementations/ciphers/cipher_aes_gcm_hw_aesni.inc"
#elif defined(SPARC_AES_CAPABLE)
# include "lib/openssl/providers/implementations/ciphers/cipher_aes_gcm_hw_t4.inc"
#elif defined(AES_PMULL_CAPABLE) && defined(AES_GCM_ASM)
# include "lib/openssl/providers/implementations/ciphers/cipher_aes_gcm_hw_armv8.inc"
#elif defined(PPC_AES_GCM_CAPABLE) && defined(_ARCH_PPC64)
# include "lib/openssl/providers/implementations/ciphers/cipher_aes_gcm_hw_ppc.inc"
#elif defined(RV64I_ZKND_ZKNE_CAPABLE)
# include "lib/openssl/providers/implementations/ciphers/cipher_aes_gcm_hw_rv64i_zknd_zkne.inc"
#elif defined(RV32I_ZBKB_ZKND_ZKNE_CAPABLE) && defined(RV32I_ZKND_ZKNE_CAPABLE)
# include "lib/openssl/providers/implementations/ciphers/cipher_aes_gcm_hw_rv32i_zknd_zkne.inc"
#else
