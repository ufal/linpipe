...
# include "lib/openssl/providers/implementations/ciphers/cipher_aes_hw_rv64i_zknd_zkne.inc"
#elif defined(RV32I_ZBKB_ZKND_ZKNE_CAPABLE) && defined(RV32I_ZKND_ZKNE_CAPABLE)
# include "lib/openssl/providers/implementations/ciphers/cipher_aes_hw_rv32i_zknd_zkne.inc"
#else
/* The generic case */
