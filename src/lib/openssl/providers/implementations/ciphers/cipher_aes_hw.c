...
#include "lib/openssl/providers/implementations/ciphers/cipher_aes.h"
...
# include "lib/openssl/providers/implementations/ciphers/cipher_aes_hw_aesni.inc"
#elif defined(SPARC_AES_CAPABLE)
# include "lib/openssl/providers/implementations/ciphers/cipher_aes_hw_t4.inc"
#elif defined(S390X_aes_128_CAPABLE)
# include "lib/openssl/providers/implementations/ciphers/cipher_aes_hw_s390x.inc"
#elif defined(OPENSSL_CPUID_OBJ) && defined(__riscv) && __riscv_xlen == 64
# include "lib/openssl/providers/implementations/ciphers/cipher_aes_hw_rv64i.inc"
#elif defined(OPENSSL_CPUID_OBJ) && defined(__riscv) && __riscv_xlen == 32
# include "lib/openssl/providers/implementations/ciphers/cipher_aes_hw_rv32i.inc"
#elif defined (ARMv8_HWAES_CAPABLE)
# include "lib/openssl/providers/implementations/ciphers/cipher_aes_hw_armv8.inc"
#else
/* The generic case */
