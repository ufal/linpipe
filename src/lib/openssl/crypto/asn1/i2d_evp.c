...
#include "lib/openssl/include/openssl/rsa.h"         /* For i2d_RSAPublicKey */
#include "lib/openssl/include/openssl/dsa.h"         /* For i2d_DSAPublicKey */
#include "lib/openssl/include/openssl/ec.h"          /* For i2o_ECPublicKey */
