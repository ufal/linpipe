...
# include <string.h>
# include <assert.h>
# include "lib/openssl/crypto/ec/curve448/arch_32/../word.h"
...
#  include "lib/openssl/crypto/ec/curve448/arch_32/../arch_32/f_impl.h"    /* Bring in the inline implementations */
#  define LIMB_MASK(i) (((1)<<LIMB_PLACE_VALUE(i))-1)
# elif (ARCH_WORD_BITS == 64)
#  include "lib/openssl/crypto/ec/curve448/arch_32/../arch_64/f_impl.h"    /* Bring in the inline implementations */
